	...
	var Map = {
		...
		map: function(){
			$('.eut-map').each( function() {
				...
				var gmapCustomEnabled = parseInt(anemos_eutf_maps_data.custom_enabled);
				var gmapLabelEnabled = parseInt(anemos_eutf_maps_data.label_enabled);
					...
					styles = [
					  {
							"featureType": "water",
							"stylers": [
								{ "color": anemos_eutf_maps_data.water_color }
							]
						},{
							"featureType": "landscape",
							"stylers": [
								{ "color": anemos_eutf_maps_data.lanscape_color }
							]
						},{
							"featureType": "poi",
							"stylers": [
								{ "color": anemos_eutf_maps_data.poi_color }
							]
						},{
							"featureType": "road",
							"elementType": "geometry",
							"stylers": [
								{ "color": anemos_eutf_maps_data.road_color }
							]
						},{
							"featureType": "transit",
							"stylers": [
							...
							"stylers": [
								{ "color": anemos_eutf_maps_data.label_color }
							]
						},{
							"featureType": "administrative.country",
							"elementType": "geometry",
							"stylers": [
								{ "color": anemos_eutf_maps_data.country_color }
							]
						}
					];
				}
